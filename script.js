...
window.addEventListener('DOMContentLoaded', function() {
    ...
    container.innerHTML = `
        <div id="loginBox" style="display:flex;flex-direction:column;align-items:center;gap:18px;background:#fff3fa;padding:7vw 4vw;border-radius:18px;box-shadow:0 4px 32px #a259e655;max-width:95vw;width:350px;">
            <h2 style="color:#a259e6;margin-bottom:10px;font-size:clamp(1.2rem,4vw,2rem);">Lütfen Giriş Yapınız .d</h2>
...
function showSurprise() {
    ...
    container.innerHTML = `
        <div id="askContinue" style="display:flex;flex-direction:column;align-items:center;gap:18px;max-width:95vw;width:350px;">
            <h2 style="color:#a259e6;font-size:clamp(1.1rem,4vw,1.5rem);">Devam etmek istiyor musun? ha gerçi hayır seçeneği yok hahsahh</h2>
...
function showFinalSurprise() {
    ...
    container.innerHTML = `
        <div id="surprise" style="display:flex;flex-direction:column;align-items:center;max-width:95vw;width:350px;">
            ...
            <button id="blowCakeBtn" style="margin-top:22px;padding:12px 28px;font-size:1.1rem;background:#ffb4e6;color:#7c3aed;border:none;border-radius:10px;cursor:pointer;width:100%;max-width:300px;font-weight:600;box-shadow:0 2px 12px #a259e633;">Pastayı Üfle 🎂</button>
        </div>
    ...
    `;
    // ...mevcut kodlar...
    document.getElementById('blowCakeBtn').addEventListener('click', function() {
